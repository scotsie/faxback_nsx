...
{'fb_ps_SendingCount': 0, 'fb_ps_ReceivingCount': 0, 'SentSeconds': 0, 'ReceivedSeconds': 0, 'fb_ps_LoginCount': 0, 'Enabled': 1, 'fb_ps_TcpCurrentCount': 2, 'fb_ps_HttpCurrentCount': 1, 'CpuTime': 10, 'StatusNum': 0}
"""

def parse_faxback_nsx_port_server(string_table) -> Dict[str, Any]:
    """
...
agent_section_faxback_nsx_port_server = AgentSection(
    name="faxback_nsx_port_server",
    parse_function=parse_faxback_nsx_port_server,
    parsed_section_name="faxback_nsx_port_server",
)

def discovery_faxback_nsx_port_server(section):
    yield Service()

def check_faxback_nsx_port_server(section):
...
check_plugin_faxback_nsx_port_server = CheckPlugin(
    name="faxback_nsx_port_server",
    service_name="Faxback NSX Port Server",
    discovery_function=discovery_faxback_nsx_port_server,
    sections=["faxback_nsx_port_server"],
    check_function=check_faxback_nsx_port_server,
)
