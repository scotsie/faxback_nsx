...
agent_section_faxback_nsx_report_server = AgentSection(
    name="faxback_nsx_report_server",
    parse_function=parse_faxback_nsx_report_server,
    parsed_section_name="faxback_nsx_report_server",
)

def discovery_faxback_nsx_report_server(section):
    yield Service()

def check_faxback_nsx_report_server(section):
...
check_plugin_faxback_nsx_report_server = CheckPlugin(
    name="faxback_nsx_report_server",
    service_name="Faxback NSX Report Server",
    discovery_function=discovery_faxback_nsx_report_server,
    sections=["faxback_nsx_report_server"],
    check_function=check_faxback_nsx_report_server,
)
