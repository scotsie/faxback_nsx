...
agent_section_faxback_nsx_conversion_server = AgentSection(
    name="faxback_nsx_conversion_server",
    parse_function=parse_faxback_nsx_conversion_server,
    parsed_section_name="faxback_nsx_conversion_server",
)

def discovery_faxback_nsx_conversion_server(section):
    yield Service()
...
check_plugin_faxback_nsx_conversion_server = CheckPlugin(
    name="faxback_nsx_conversion_server",
    service_name="Faxback NSX Conversion Server",
    discovery_function=discovery_faxback_nsx_conversion_server,
    sections=["faxback_nsx_conversion_server"],
    check_function=check_faxback_nsx_conversion_server,
)
